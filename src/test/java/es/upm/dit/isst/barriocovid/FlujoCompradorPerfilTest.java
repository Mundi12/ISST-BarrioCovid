...
import java.net.URL;
public class FlujoCompradorPerfilTest {
  ...
  @Test
  public void flujoCompradorPerfil() {
    ...
    driver.findElement(By.id("direccion")).sendKeys("Calle Alcalá,15, 5B");
    driver.findElement(By.cssSelector(".btn")).click();
    driver.findElement(By.id("navbarDropdownMenuLink")).click();
    driver.findElement(By.linkText("Mi perfil")).click();
    driver.findElement(By.id("direccion")).click();
    driver.findElement(By.id("direccion")).sendKeys("Calle Alcalá,15, 3A");
    driver.findElement(By.cssSelector(".btn")).click();
    driver.findElement(By.id("navbarDropdownMenuLink")).click();
